...
var creatorList = ['@pandu','@pandugans','@pandu_ajalah','@panduanjay', '@panduganssss','@panduganteng','@pandugantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'panduGans') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'panduGans') return res.json(loghandler.invalidKey)
